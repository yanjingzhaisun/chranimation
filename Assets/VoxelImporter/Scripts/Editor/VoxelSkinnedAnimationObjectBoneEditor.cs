            ...
            if (SceneView.currentDrawingSceneView == SceneView.lastActiveSceneView)
            {
                ...
                if (objectTarget.editMode == VoxelSkinnedAnimationObject.Edit_Mode.BoneAnimation)
                {
                    ...
                    #region Tool
                    {
                        ...
                        float x, y;
                        {
                            var editorBoxRect = new Rect(2, 2, 204, 96 + 56 * mirrorCount);
                            ...
                            #region "?"
                            {
                                if (GUI.Button(new Rect(editorBoxRect.x + editorBoxRect.width - 16, editorBoxRect.y, 16, 16), "?", objectTarget.edit_helpEnable ? editorCommon.guiStyleActiveButton : GUI.skin.button))
                                {
                ...
                else if (objectTarget.editMode == VoxelSkinnedAnimationObject.Edit_Mode.BonePosition)
                {
                    #region Tool
                    {
                        Handles.BeginGUI();
                        {
                            var editorBoxRect = new Rect(2, 2, 204, 68);
                        ...
                        {
                            EditorGUI.BeginChangeCheck();
                            var edit_snapToHalfVoxel = GUI.Toggle(new Rect(x, y, 200, 16), objectTarget.edit_snapToHalfVoxel, "Snap to half-voxel", editorCommon.guiStyleToggleLeft);
                            if (EditorGUI.EndChangeCheck())
                            {
