...
#if U5
        GUI.DrawTexture(rect, tex, ScaleMode.StretchToFill, false); //disable alphaBlend in U5 too
#else
        GUI.DrawTexture(rect, tex, ScaleMode.StretchToFill, false); //disable alphaBlend in U4, http://forum.unity3d.com/threads/render-texture-alpha.2065/
#endif
	}
